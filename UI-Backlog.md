...
3. **Formatwahl prominent als Modul-Tabs** direkt im Einstieg — im StoryboardCreator versteckt als Select in der Metadatenzeile.
...
- Footer zeigt stattdessen Textvariante „StoryboardCreator · Inhalte bleiben auf deinem Gerät" (SMC-Muster).
